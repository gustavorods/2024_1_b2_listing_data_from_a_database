...
<body>
    ...
    <form name="cliente" method="POST" action="">
        <fieldset id="A">
            ...
            <input name="txtnome" type="text" size="40" maxlength="40" placeholder="Primeiro nome do autor">
        ...
        <fieldset id="b">
            ...
            if(isset($btnenviar)) {
                ...
                foreach($pro_bd as $pro_mostrar) {
                    ...
                    <p><b>Sobrenome:</b> <?php echo $pro_mostrar[2]; ?></p>
                    <p><b>Email:</b> <?php echo $pro_mostrar[3]; ?></p>

                    <!--Calculando idade--> 
                    <?php
                        $dataAtual = new DateTime("2024-08-28");
                        $dataNascimento = new DateTime($pro_mostrar[4]);
