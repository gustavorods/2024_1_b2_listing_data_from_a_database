...
<body>
    <div class="container">
        ...
        <form action="./alterar_autoria.php" method="POST" name="cliente">
            <label for="autor-id">Informe o ID do autor:</label>
            <input type="text" id="autor-id" name="autor-id" placeholder="Digite o ID do autor" required>
            
            <label for="livro-id">Informe o ID do livro:</label>
            <input type="text" id="livro-id" name="livro-id" placeholder="Digite o ID do livro" required>
